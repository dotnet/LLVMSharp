...
mcs /target:library /out:LLVMSharp.dll Conversions.cs ExecutionEngine.cs Generated.cs IRBuilder.cs LLVMBasicBlockRef.cs LLVMContextRef.cs LLVMTypeRef.cs LLVMValueRef.cs Module.cs Overloads.cs PassManager.cs