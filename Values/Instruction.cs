namespace LLVMSharp
{
    public class Instruction : Value
    {
        ...
        {
            return LLVM.GetMetadata(this.Unwrap(), kindID).Wrap<Value>();
        }
        ...
        {
            return LLVM.GetNextInstruction(this.Unwrap()).Wrap<Value>();
        }

        public Value GetPreviousInstruction()
        {
            return LLVM.GetPreviousInstruction(this.Unwrap()).Wrap<Value>();
        }
        ...
        {
            return LLVM.InstructionClone(this.Unwrap()).Wrap<Value>();
        }
