namespace LLVMSharp
{
    ...
    public sealed class IRBuilder : IDisposable, IEquatable<IRBuilder>, IWrapper<LLVMBuilderRef>
    {
        ...
        {
            return CreateICmp(LLVMIntPredicate.LLVMIntEQ, lhs, rhs, name);
        }

        public ICmpInst CreateICmpNE(Value lhs, Value rhs, string name)
        {
            return CreateICmp(LLVMIntPredicate.LLVMIntNE, lhs, rhs, name);
        }

        public ICmpInst CreateICmpUGT(Value lhs, Value rhs, string name)
        {
            return CreateICmp(LLVMIntPredicate.LLVMIntUGT, lhs, rhs, name);
        }

        public ICmpInst CreateICmpULT(Value lhs, Value rhs, string name)
        {
            return CreateICmp(LLVMIntPredicate.LLVMIntULT, lhs, rhs, name);
        }

        public ICmpInst CreateICmpULE(Value lhs, Value rhs, string name)
        {
            return CreateICmp(LLVMIntPredicate.LLVMIntULE, lhs, rhs, name);
        }

        public ICmpInst CreateICmpSGT(Value lhs, Value rhs, string name)
        {
            return CreateICmp(LLVMIntPredicate.LLVMIntSGT, lhs, rhs, name);
        }

        public ICmpInst CreateICmpSGE(Value lhs, Value rhs, string name)
        {
            return CreateICmp(LLVMIntPredicate.LLVMIntSGE, lhs, rhs, name);
        }

        public ICmpInst CreateICmpSLT(Value lhs, Value rhs, string name)
        {
            return CreateICmp(LLVMIntPredicate.LLVMIntSLT, lhs, rhs, name);
        }

        public ICmpInst CreateICmpSLE(Value lhs, Value rhs, string name)
        {
            return CreateICmp(LLVMIntPredicate.LLVMIntSLE, lhs, rhs, name);
        }
        ...
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealOEQ, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpOGT(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealOGT, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpOGE(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealOGE, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpOLT(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealOLT, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpOLE(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealOLE, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpONE(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealONE, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpORD(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealORD, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpUNO(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealUNO, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpUEQ(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealUEQ, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpUGT(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealUGT, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpUGE(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealUGE, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpULT(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealULT, lhs, rhs, name);
        }

        public FCmpInst CreateFCmpUNE(Value lhs, Value rhs, string name)
        {
            return CreateFCmp(LLVMRealPredicate.LLVMRealUNE, lhs, rhs, name);
        }
